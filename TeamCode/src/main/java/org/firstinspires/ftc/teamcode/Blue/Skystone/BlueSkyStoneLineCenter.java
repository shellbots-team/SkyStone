package org.firstinspires.ftc.teamcode.Blue.Skystone;
...
@Autonomous(group="Basic", name = "Blue: SkyStone Line Center")
public class BlueSkyStoneLineCenter extends BaseAutonomous {
